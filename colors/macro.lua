...
local hlgroups = {
  ...
  ["@markup.heading.1.markdown"] = { fg = c_macroRed, bold = true },
  ["@markup.heading.2.markdown"] = { fg = c_macroRed, bold = true },
  ["@markup.heading.3.markdown"] = { fg = c_macroRed, bold = true },
  ["@markup.heading.4.markdown"] = { fg = c_macroRed, bold = true },
  ["@markup.heading.5.markdown"] = { fg = c_macroRed, bold = true },
  ["@markup.heading.6.markdown"] = { fg = c_macroRed, bold = true },
