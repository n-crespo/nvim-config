...
local hlgroups = {
  ...
  TabLineFill = { bg = vim.g.FullsizeTabs and c_macroBg2 or nil, fg = c_macroFg1 },
  TabLineSel = { bg = vim.g.FullsizeTabs and selection_light_gray or c_macroBg2, fg = c_macroFg0, bold = true },
