...
-- for each column find max width for each cell (including padding)
-- for each column from start (get value from cell -> align it -> add padding -> goto next cell until everything done)
--
