return {
  ...
  config = function()
    ...
    require("smoothcursor").setup({
      ...
      disabled_filetypes = { "minifiles", "better_term", "TelescopePrompt" }, -- Disable for these file types, ignored if enabled_filetypes is set. e.g., { "TelescopePrompt", "NvimTree" }
